...
export default function Sidebar({ hasData, numFeatures, filename, fileFormat, setFileFormat, useAddress, setUseAddress, error, handleFile, clearFile, mapLoaded }: SidebarProps){
  ...
  return (
    <div className="bg-slate-400 h-full p-4 overflow-hidden">
      ...
      <FileInput fileFormat={fileFormat} mapLoaded={mapLoaded} handleFile={handleFile} clearFile={clearFile} />
