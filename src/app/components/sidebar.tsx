...
export default function Sidebar({ hasData, numFeatures, filename, fileFormat, setFileFormat, useAddress, setUseAddress, error, handleFile, clearFile }: SidebarProps){
